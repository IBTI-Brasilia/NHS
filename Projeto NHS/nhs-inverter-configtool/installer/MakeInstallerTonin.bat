...
set RL=C:\Users\IBTI\Documents\build-NHSInverterConfig-Desktop_Qt_5_12_3_MinGW_64_bit-Release\release
::Path para a pasta installer
set INST=C:\Users\IBTI\Documents\nhs-inverter-configtool\installer
::Path para o icone do programa
set ICON=C:\Users\IBTI\Documents\build-NHSInverterConfig-Desktop_Qt_5_12_3_MinGW_64_bit-Release\release\app.ico
::Path para 7-zip - Tem aspas pq "Program Files" tem um espaço :(
set sz="C:\Program Files\7-Zip\7z"
::Nome do instalador
